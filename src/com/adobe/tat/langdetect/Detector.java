package com.adobe.tat.langdetect;

import com.adobe.tat.langdetect.util.NGram;
 ...
 * <pre>
 * import java.util.ArrayList;
 * import com.adobe.tat.langdetect.Detector;
 * import com.adobe.tat.langdetect.DetectorFactory;
 * import com.adobe.tat.langdetect.Language;
 *
...
public class Detector {
     ...
     *
     * @param wordLangProbMap {@link DetectorFactory} instance (only DetectorFactory inside)
     * @param langlist        {@link DetectorFactory} instance (only DetectorFactory inside)
     * @param wordLangProbMap {@link DetectorFactory} instance (only DetectorFactory inside)
     */
    public Detector(HashMap<String, double[]> wordLangProbMap, ArrayList<String> langlist, Long seed) {

...
import com.adobe.tat.langdetect.util.LangProfile;
...
public class Command {
     ...
     */
    private boolean loadProfile(DetectorFactory detectorFactory) {
     ...
     * 
     */
    public void detectLang(DetectorFactory detectorFactory) {
        if (loadProfile(detectorFactory)) return;
     ...
     *  
     */
    public void batchTest(DetectorFactory detectorFactory) {
        if (loadProfile(detectorFactory)) return;
    ...
    public static void main(String[] args) {
        ...
        if (command.hasOpt("--genprofile")) {
            ...
            command.detectLang(detectorFactory);
        } else if (command.hasOpt("--batchtest")) {
            command.batchTest(detectorFactory);
        }
    }
